...
function encodeToRot13(str) {
  // throw new Error('Not implemented');
  return str.replace(/[A-Z]/gi, (count) => 'NOPQRSTUVWXYZABCDEFGHIJKLMnopqrstuvwxyzabcdefghijklm'[
    'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'.indexOf(count)]);
}
