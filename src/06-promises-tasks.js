...
function willYouMarryMe(isPos) {
  ...
  return new Promise((resolve, reject) => {
    if (typeof isPos !== 'boolean') { reject(new Error('Wrong parameter is passed! Ask her again.')); }
    if (isPos) resolve('Hooray!!! She said "Yes"!');
    if (!isPos) resolve('Oh no, she said "No".');
  });
}
